...
const KEEPALIVE_BEFORE_GIVEN = 60000;
const TIMEOUT_AFTER_GIVEN = 300000;
...
class TunnelAgent extends Agent {
    ...
    _onConnection(socket) {
        ...
        socket.setKeepAlive(true, KEEPALIVE_BEFORE_GIVEN);
    ...
    setSocketTimeout(socket) {
        socket.setTimeout(TIMEOUT_AFTER_GIVEN);
        socket.on('timeout', () => {
